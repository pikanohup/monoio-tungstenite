...
pub enum ProtocolError {
    ...
    /// The `Sec-WebSocket-Accept` header is either not present or does not specify the correct key
    /// value.
    ...
    /// Invalid header is passed. Or the header is missing in the request. Or not present at all.
    /// Check the request that you pass.
